...
void laserLoopOptimizationClass::save_and_update_PGnode(const pcl::PointCloud<PointType>::Ptr& thisKeyFrame, pcl::PointCloud<PointType>::Ptr thisKeyFrame_surf, pcl::PointCloud<PointType>::Ptr thisKeyFrame_edge, Pose6D& pose_curr, double& timeLaserOdometry, double& timeLaser, double& timeGroud_truth)
{
    //
