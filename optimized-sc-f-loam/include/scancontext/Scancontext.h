...
public:
    ...
    double SC_DIST_THRES = 0.6/*0.2*/; // 0.4-0.6 is good choice for using with robust kernel (e.g., Cauchy, DCS) + icp fitness threshold / if not, recommend 0.1-0.15
    ...
    //KeyMat = std::vector<std::vector<float> >
